                ...
                <div class="col-lg-3">
                    <div class="contact-right-items">
                        <div class="contact-img">
                            <img src="<?= base_url('assets/landing-assets') ?>/img/contact.jpg" alt="img">
                        </div>
                        <div class="icon-items">
                            <div class="icon">
                                <img src="<?= base_url('assets/landing-assets') ?>/img/question.png" alt="img">
                            </div>
                            <div class="content">
                                <p>Have Question?</p>
                        ...
                        <div class="icon-items">
                            <div class="icon">
                                <img src="<?= base_url('assets/landing-assets') ?>/img/email.png" alt="img">
                            </div>
                            <div class="content">
                                <p>Write Email</p>
                        ...
                        <div class="icon-items">
                            <div class="icon">
                                <img src="<?= base_url('assets/landing-assets') ?>/img/location.png" alt="img">
                            </div>
                            <div class="content">
                                <p>Visit Office</p>
                                <h6>
