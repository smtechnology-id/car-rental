        ...
        <!--<< All JS Plugins >>-->
        <script src="<?= base_url('assets/landing-assets') ?>/js/jquery-3.7.1.min.js"></script>
        <!--<< Viewport Js >>-->
        <script src="<?= base_url('assets/landing-assets') ?>/js/viewport.jquery.js"></script>
        <!--<< Bootstrap Js >>-->
        <script src="<?= base_url('assets/landing-assets') ?>/js/bootstrap.bundle.min.js"></script>
        <!--<< Nice Select Js >>-->
        <script src="<?= base_url('assets/landing-assets') ?>/js/jquery.nice-select.min.js"></script>
        <!--<< Waypoints Js >>-->
        <script src="<?= base_url('assets/landing-assets') ?>/js/jquery.waypoints.js"></script>
        <!--<< Counterup Js >>-->
        <script src="<?= base_url('assets/landing-assets') ?>/js/jquery.counterup.min.js"></script>
        <!--<< Datepicker Js >>-->
        <script src="<?= base_url('assets/landing-assets') ?>/js/bootstrap-datepicker.js"></script>
        <!--<< Swiper Slider Js >>-->
        <script src="<?= base_url('assets/landing-assets') ?>/js/swiper-bundle.min.js"></script>
        <!--<< MeanMenu Js >>-->
        <script src="<?= base_url('assets/landing-assets') ?>/js/jquery.meanmenu.min.js"></script>
        <!--<< Magnific Popup Js >>-->
        <script src="<?= base_url('assets/landing-assets') ?>/js/jquery.magnific-popup.min.js"></script>
        <!--<< GSAP Animation Js >>-->
        <script src="<?= base_url('assets/landing-assets') ?>/js/animation.js"></script>
        <!--<< Wow Animation Js >>-->
